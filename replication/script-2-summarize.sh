...
## REPLICATION - 255 CASES ##
summarize \
/uufs/chpc.utah.edu/common/home/u0690571/github/rare-variants-gwas-loci/replication \
samples-255-cases.txt \
replication-gnomad-filtered.vcf.gz \
2 \
gnomad-filtered-replication.vcf.gz \
/uufs/chpc.utah.edu/common/home/u0690571/github/rare-variants-gwas-loci/replication/summary-255-cases.txt 
